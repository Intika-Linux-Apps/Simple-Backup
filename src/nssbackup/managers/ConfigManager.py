...
# TODO: remove command-line parsing from here; this class should only take a filenam as parameter
    ...
    def setValidOpts(self, valid_options):
...
class ConfigurationFileHandler(object):
    ...
    def get_conffile(self):
        ...
        if self.__super_user:
            conffile = os.path.join(ConfigStaticData.get_superuser_confdir(),
                                    ConfigStaticData.get_default_conffile())
        else:
    ...
    def get_profilesdir(self, conffile):
        ...
        profdir  = os.path.join(confdir, ConfigStaticData.get_profiles_dir())
        return profdir
...
class ConfigStaticData(object):
    ...
    :todo: create a separate class for storing paths and filenames!
    ...
    # all valid options and their types - used for validation of conf-files
    __our_options = {
